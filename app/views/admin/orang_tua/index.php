<div class="mt-14 sm:ml-60 p-6 bg-blue-900 min-h-screen">
    <div class="p-5 bg-gray-100 shadow-lg rounded-lg">
        <h1 class="text-2xl font-bold mb-4 text-blue-900">Orang Tua</h1>
        ...
        <div class="p-5 bg-white shadow-lg rounded-lg">
            <table class="w-full border-collapse bg-white shadow-lg rounded-lg" id="admin-table">
                ...
                <tbody class="rounded-b-lg">
                    <?php $no = 1;
                    foreach ($data['orang_tua'] as $orang_tua): ?>
                            ...
                            <td class="p-3">
                                <div class="flex space-x-2">
                                    ...
                                    <button
                                        ...
                                        onclick="confirmDelete('orang_tua/delete', <?= $orang_tua['id_orang_tua'] ?>)">
                                        <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                            fill="currentColor" viewBox="0 0 24 24">
                                            <path fill-rule="evenodd"
    ...
    <div class="relative w-full max-w-4xl max-h-full">
        <div class="relative bg-white rounded-lg shadow-lg">
            <div class="flex items-center justify-between p-4 border-b rounded-t">
                <h3 id="modalLabel" class="text-lg font-semibold">Tambah Data Orang Tua</h3>
                <button type="button"
            ...
            <div class="modal-body">
                <form action="<?= BASEURL_ADMIN ?>/orang_tua/quran" method="POST" id="form" class="p-6">
...
<script>
    function editOrangTua(id_orang_tua, id_user, nama_orang_tua) {
        document.getElementById('modalLabel').innerText = 'Ubah Data Orang Tua';
